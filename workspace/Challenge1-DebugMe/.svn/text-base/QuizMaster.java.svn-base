//UIUC CS125 FALL 2014 MP. File: QuizMaster.java, CS125 Project: Challenge1-DebugMe, Version: 2015-09-07T21:58:15-0500.221514203
/**
...
public class QuizMaster {
	...
	public static void main(String[] args) {
		...
		if(score < 40 && zip/1000 == 48) score =0;
		
		if(zip/1000 == 53) score = score;
